...
rows = [
  ...
  # Adesivi
  # ----------------
  { key: "Respira Piano", category: "Adesivi", kind: "image", payload: "/media/img/respira_15.webp" },
  { key: "Piangi Duro", category: "Adesivi", kind: "image", payload: "/media/img/piangi_30.webp" },
  { key: "Ridi Forte", category: "Adesivi", kind: "image", payload: "/media/img/ridi_60.webp" }
